import { TahlilItem } from "./tahlil";
import { TAHLIL_AL_BAQARAH } from "./tahlilAlBaqarah";

export const TAHLIL_FULL: TahlilItem[] = [
  // TAWASSUL
  {
    type: "text",
    arab: "Tawassul",
  ...
  {
    type: "text",
    arab: "إِلَى حَضْرَةِ النَّبِيِّ الْمُصْطَفَى سَيِّدِنَا مُحمَّدٍ صَلَّى اللهُ عَلَيْهِ وَسَلَّمَ وَاٰلِهِ وَأَزْوَاجِهِ وَأَوْلَادِهِ وَذُرِّيَّاتِهِ الْفَــاتِحَةُ",
    latin:
  ...
  },
  {
    ...
    arti: "Kemudian kepada semua ahli kubur Muslimin, Muslimat, Mukminin, Mukminat dari Timur ke Barat, baik di laut dan di darat, khususnya bapak kami, ibu kami, kakek kami, nenek kami, guru kami, pengajar dari guru kami, mereka yang telah berbuat baik kepada kami, dan bagi ahli kubur/arwah yang menjadi sebab kami berkumpul di sini. Bacaan Al-Fatihah ini kami tujukan kepada Allah dan pahalanya untuk mereka semua. Al-Fatihah.",
  },
  {
    type: "text",
    arab: "ثُمَّ إِلَى جَمِيْعِ أهْلِ الْقُبُوْرِ مِمَّنْ ذُكِرَتْ أَسْمَاؤُهُ فِيْ هٰذِهِ الرِّسَالَةِ حَضْرَةِ رُوْحِ … وَحَضْرَةِ رُوْحِ … وَحَضْرَةِ رُوْحِ … رَحِمَهُمُ اللهُ وَغَفَرَهُمْ، الْفَاتِحَةُ",
    latin:
    ...
    arti: "Kemudian kepada semua ahli kubur, yang namanya disebutkan dalam risalah ini. Kepada…, dan kepada…, dan kepada…. Semoga Allah merahmati dan mengampuni mereka. Bacaan Al-Fatihah ini kami tujukan kepada Allah dan pahalanya untuk mereka semua. Al-Fatihah.",
  },

  // AL IKHLAS ×3
  {
    type: "text",
    arab: "Surah Al-Ikhlas ×3",
    latin: "Surah Al-Ikhlas ×3",
    arti: "",
  },
  ...
  { type: "surah", surahId: 112 },

  {
    type: "text",
    arab: "لَا إِلٰهَ إِلَّا اللهُ وَاللهُ أَكْبَرُ",
    latin: "Lā ilāha illallāhu wallāhu akbar",
    arti: "Tiada Tuhan selain Allah, Allah Maha Besar",
  },
  ...
  { type: "surah", surahId: 113 },

  {
    type: "text",
    arab: "لَا إِلٰهَ إِلَّا اللهُ وَاللهُ أَكْبَرُ",
  ...
  {
    type: "text",
    arab: "وَإِلٰهُكُمْ إِلٰهٌ وَّاحِدٌ لَا إِلٰهَ إِلَّا هُوَ الرَّحْمٰنُ الرَّحِيمُ",
  ...
  {
    type: "text",
    arab: `اللّٰهُ لَآ اِلٰهَ اِلَّا هُوَ الْحَيُّ الْقَيُّوْمُ ۚ لَا تَأْخُذُهٗ سِنَةٌ وَّلَا نَوْمٌ ۚ
لَهٗ مَا فِى السَّمٰوٰتِ وَمَا فِى الْاَرْضِ ۗ
مَنْ ذَا الَّذِيْ يَشْفَعُ عِنْدَهٗٓ اِلَّا بِاِذْنِهٖ ۗ
يَعْلَمُ مَا بَيْنَ اَيْدِيْهِمْ وَمَا خَلْفَهُمْ ۖ
وَلَا يُحِيْطُوْنَ بِشَيْءٍ مِّنْ عِلْمِهٖٓ اِلَّا بِمَا شَاۤءَ ۚ
...
Man dhalladzī yashfa'u 'indahū illā bi idhnih.
Ya'lamu mā baina aydīhim wa mā khalfahum.
Wa lā yuḥīṭūna bishai'in min 'ilmihī illā bimā shā'.
Wasi'a kursiyyuhus-samāwāti wal-arḍ.
Wa lā ya'ūduhū ḥifẓuhumā.
Wa huwal-'aliyyul-'aẓīm.`,
    arti: `Allah, tidak ada Tuhan selain Dia Yang Maha Hidup dan terus mengurus makhluk-Nya.
Dia tidak mengantuk dan tidak tidur.
Milik-Nya apa yang di langit dan di bumi.
Tidak ada yang dapat memberi syafaat tanpa izin-Nya.
Dia mengetahui apa yang di hadapan dan di belakang mereka.
Mereka tidak mengetahui sesuatu dari ilmu-Nya kecuali yang Dia kehendaki.
...
Dia Maha Tinggi lagi Maha Agung.`,
  ...
  {
    type: "text",
    arab: "أَسْتَغْفِرُ اللهَ الْعَظِيْمَ ×٣",
    latin: "Astaghfirullāhal-'aẓīm ×3",
    arti: "Aku memohon ampun kepada Allah Yang Maha Agung",
  },
  {
    type: "text",
    arab: "أَفْضَلُ الذِّكْرِ فَاعْلَمْ أَنَّهُ لَا إِلٰهَ إِلَّا اللهُ، حَيٌّ مَوْجُوْدٌ",
    latin:
      "Afdlaludz dzikri fa‘lam annahu lâ ilâha illallâhu ḫayyun maujûd(un)",
    arti: "Sebaik-baik dzikir–ketahuilah–adalah lafal ‘Lâ ilâha illallâh’, tiada tuhan selain Allah, Dzat yang Mahahidup dan Wujud.",
  },
  {
    type: "text",
    arab: "لَا إِلٰهَ إِلَّا اللهُ، حَيٌّ مَعْبُوْدٌ",
    latin: "La ilâha illâllâhu ḫayyun ma‘bûd",
    arti: "Tiada tuhan selain Allah, Dzat yang mahahidup dan disembah.",
  },
  {
    type: "text",
    arab: "لَاَ إِلٰهَ إِلَّا اللهُ، حَيٌّ بَاقٍ",
    latin: "La ilâha illâllâhu ḫayyun bâq",
    arti: "Tiada tuhan selain Allah, Dzat yang Mahahidup dan kekal.",
  },
  {
    type: "text",
    arab: "لَا إِلٰهَ إِلَّا اللهُ ×١٠٠",
    latin: "La ilâha illâllâh 100x",
    arti: "Tiada tuhan selain Allah (100 kali).",
  },
  {
    type: "text",
    arab: "اَللّٰهُمَّ صَلِّ عَلَى سَيِّدِنَا مُحَمَّدٍ اَللّٰهُمَّ صَلِّ عَلَيْهِ وَسَلِّمْ ×٢",
    latin:
      "Allâhumma shalli ‘alâ sayyidinâ Muḫammadin, Allâhumma shalli ‘alaihi wa sallim",
    arti: "Ya Allah, limpahkan rahmat takzim dan keselamatan kepada pemimpin kami, Nabi Muhammad (2 kali).",
  },
  {
    type: "text",
    arab: "سُبْحَــانَ اللهِ عَدَدَ مَـــا خَلَقَ اللهُ ×٧",
    latin: "Subḫânallâhi ‘adada mâ khalaqallâhu",
    arti: "Mahasuci Allah sebanyak makhluk yang Allah ciptakan (7 kali).",
  },
  {
    type: "text",
    arab: "سُبحَانَ اللهِ وَبِحَمْدِهِ سُبْحَانَ اللهِ الْعَظِيْمِ ×٣٣",
    latin: "Subḫânallâhi wa biḫamdihi subḫânallâhil ‘adhîm",
    arti: "Mahasuci Allah dengan segala pujian untuk-Nya. Mahasuci Allah yang Mahaagung (33 kali)",
  },
  {
    type: "text",
    arab: "اَللّٰهُمَّ صَلِّ عَلَى حَبِيْبِكَ سَيِّدِنَا مُحَمَّدٍ وَعَلَى اٰلِهِ وَصَحْبِهِ وَسَلِّمْ ×٢",
    latin:
      "Allâhumma shalli ‘alâ ḫabîbika sayyidinâ Muḫammadin wa âlihi wa shaḫbihi wa sallim 2x",
    arti: "Ya Allah, limpahkan rahmat takzim dan keselamatan kepada kekasih-Mu, pemimpin kami, Nabi Muhammad, berikut keluarga dan sahabatnya (2 kali).",
  },
  {
    type: "text",
    arab: "﴿الدعاء﴾ أَعُوْذُ بِاللهِ مِنَ الشَّيْطَانِ الرَّجِيْمِ، بِسْمِ اللهِ الرَّحْمٰنِ الرَّحِيْمِ، الْحَمْدُ لِلّٰهِ رَبِّ الْعٰلَمِيْنَ، حَمْدَ الشَّاكِرِيْنَ حَمْدَ النَّاعِمِيْنَ، حَمْدًا يُّوَافِي نِعَمَهُ وَيُكَافِئُ مَزِيْدَهُ، يَا رَبَّنَا لَكَ الْحَمْدُ كَمَا يَنْبَغِيْ لِجَلَالِ وَجْهِكَ وَعَظِيْمِ سُلْطَانِكَ، اللّٰهُمَّ صَلِّ عَلَى سَيِّدِنَا مُحَمَّدٍ وَّعَلَى اٰلِ سَيِّدِنَا مُحِمَّدٍ",
    latin:
  ...
  },
  {
    ...
    arti: "Ya Allah ampunilah mereka, kasihanilah mereka, dan maafkanlah mereka. Ya Allah turunkanlah rahmat, dan ampunan kepada ahlul kubur yang ahli mengucapkan “Laa ilaaha illaallah, Muhammadur rasulullah” (Tidak ada tuhan selain Allah, Muhammad Utusan Allah).",
  },
  {
    type: "text",
    arab: "رَبَّنَا أَرِنَا الْحَقَّ حَقًّا وَّارْزُقْنَا اتِّبَاعَهُ، وَأَرِنَا الْبَاطِلَ بَاطِلًا وَّارْزُقْنَا اجْتِنَابَهُ، رَبَّنَا اٰتِنَا فِي الدُّنْيَا حَسَنَةً وَّفِي الْآخِرَةِ حَسَنَةً وَّقِنَا عَذَابَ النَّارِ، سُبْحَانَ رَبِّكَ رَبِّ الْعِزَّةِ عَمَّا يَصِفُوْنَ وَسَلَامٌ عَلَى الْمُرْسَلِيْنَ وَالْحَمْدُ لِلّٰهِ رَبِّ الْعَلَمِيْنَ، اَلْفَاتِحَة",
    latin:
